...
' Last Result, IgnoreNew and RestartOnFailure keep meaning exactly what they
' meant with a visible console action. Registered actions look like:
'   wscript.exe //B //Nologo "ops\hidden.vbs" C:\Windows\System32\cmd.exe /d /c "ops\run.cmd" <args>
Dim sh, i, part, cmd
